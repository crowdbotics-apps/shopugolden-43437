"""
Django settings for shopugolden_43437 project.
...
ROOT_URLCONF = 'shopugolden_43437.urls'
...
WSGI_APPLICATION = 'shopugolden_43437.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "shopugolden_43437 API",
    "DESCRIPTION": "API documentation for shopugolden_43437 App",
    "VERSION": "v1",
}
